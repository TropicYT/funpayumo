...
Utils.cardinal_tools.set_console_title(f"FunPay Cardinal(YUMO ADAPTIVE) v{VERSION}")
...
print(f"{Fore.MAGENTA}{Style.BRIGHT}By {Fore.BLUE}{Style.BRIGHT}Woopertail, @sidor0912 (official developers){Style.RESET_ALL}")
print(
    f"{Fore.MAGENTA}{Style.BRIGHT} * GitHub: {Fore.BLUE}{Style.BRIGHT}https://github.com/TropicYT/funpayumo{Style.RESET_ALL}")
print(f"{Fore.MAGENTA}{Style.BRIGHT} * Телеграм хостинга: {Fore.BLUE}{Style.BRIGHT}https://t.me/yumo_hosting")
print(f"{Fore.MAGENTA}{Style.BRIGHT} * Плагины: {Fore.BLUE}{Style.BRIGHT}https://t.me/+DCKZlkiyAhIwM2Ey")
print(f"{Fore.MAGENTA}{Style.BRIGHT} * Мы не притендуем на права FunPayCardinal! Мы просто адаптировали его под наш хостинг! Спасибо за понимание")
