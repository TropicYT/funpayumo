...
class TGBot:
    def __init__(self, cardinal: Cardinal):
        ...
        self.commands = {
            ...
            "profile": "cmd_profile",
            "restart": "cmd_restart",
            # УДАЛЕНО: "check_updates": "cmd_check_updates",
            # УДАЛЕНО: "update": "cmd_update",
            ...
            "about": "cmd_about",
            "sys": "cmd_sys",
            # УДАЛЕНО: "get_backup": "cmd_get_backup",
            # УДАЛЕНО: "create_backup": "cmd_create_backup",
            # УДАЛЕНО: "upload_backup": "cmd_upload_backup",
    ...
    # УДАЛЕНЫ функции check_updates, get_backup, create_backup, update
    ...
    def __register_handlers(self):
        ...
        # УДАЛЕНЫ команды: check_updates, update, get_backup, create_backup, upload_backup
    ...
    def edit_bot(self):
        ...
        sh_text = "🛠️ https://t.me/+DCKZlkiyAhIwM2Eyll"
