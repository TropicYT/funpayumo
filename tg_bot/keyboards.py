...
def LINKS_KB(language: None | str = None) -> K:
    return K().add(B(_("lnk_github", language=language),
                     url="https://github.com/TropicYT/funpayumo")) \
        .add(B(_("lnk_updates", language=language), url="1231231231")) \
        .add(B(_("mm_plugins", language=language), url="123123123")) \
        .add(B(_("lnk_chat", language=language), url="123123123"))
